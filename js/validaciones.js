...
const mensajesDeError = {
    ...
    numero:{
        valueMissing: "Este campo numero de teléfono no puede estar vacio.",
        patternMismatch: "El formato requerido es XX XXXX XXXX"
    },
    direccion: {
        valueMissing: "Este campo dirección no puede estar vacio.",
        patternMismatch: "Debe tener al menos entre 10 y 40 caracteres"
    },
    ciudad: {
        valueMissing: "Este campo dirección no puede estar vacio.",
        patternMismatch: "La Ciudad debe tener al menos entre 5 y 40 caracteres"
    },
    provincia: {
        valueMissing: "Este campo dirección no puede estar vacio.",
        patternMismatch: "La provincia debe tener al menos entre 5 y 40 caracteres"
    }
